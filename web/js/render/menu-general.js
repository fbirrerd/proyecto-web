...
function fetchMenus() {
    let params;
    callApi('GET', 'menu/generales/all', params)
...
function llenarTabla() {
    ...
    currentData.forEach(menu => {
        ...
        $row.append(
            ...
            $("<td>").append(`<input type="text" class="form-control form-control-sm" id="nombre-${menu.id}" value="${menu.nombre}">`),
            $("<td>").append(`<input type="text" class="form-control form-control-sm" id="ruta-${menu.id}" value="${menu.ruta ?? ''}">`),
            $("<td>").append(`<select class="form-select form-select-sm" id="tipo-${menu.id}">
            ...
            $("<td>").append(`
                <select class="form-select form-select-sm" id="estado-${menu.id}">
                    <option value="true" ${menu.estado ? "selected" : ""}>Activo</option>
                    <option value="false" ${!menu.estado ? "selected" : ""}>Inactivo</option>
                </select>
            `),
            $("<td>").append(`
                <button class="btn btn-success btn-sm guardar-btn" data-id="${menu.id}">
                    <i class="fas fa-save"></i> Guardar
                </button>
                <button class="btn btn-warning btn-sm editar-btn" data-id="${menu.id}">
